...
//getting lcoal storage ntoes if extist and parsing them
//to js object else  pssing an empty array to notes
...
addBtn.addEventListener('click', e=>{
    ...
    if(noteTitle || noteDesc){
        //getting the month, day, and year from the current date
